...
class RetirosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create retiro" do
    assert_difference("Retiro.count") do
      post retiros_url, params: { retiro: { direccion: @retiro.direccion, email: @retiro.email, nombre: @retiro.nombre, telefono: @retiro.telefono } }
    end
  ...
  test "should update retiro" do
    patch retiro_url(@retiro), params: { retiro: { direccion: @retiro.direccion, email: @retiro.email, nombre: @retiro.nombre, telefono: @retiro.telefono } }
